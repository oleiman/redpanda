...
/// No-op admission policy. admit/try_admit always succeed; release
/// is a no-op. Concurrency is bounded by the client pool's capacity
/// alone — the scheduler call sites are present for future policies
/// but do not throttle.
