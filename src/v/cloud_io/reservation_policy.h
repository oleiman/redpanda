...
public:
    ...
    /// dwell-window testing. Must be noexcept: it is called from the
    /// noexcept abort-source subscription in admit().
    using now_fn_t
      = ss::noncopyable_function<ss::lowres_clock::time_point() noexcept>;
