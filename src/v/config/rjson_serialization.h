...
void rjson_serialize(
  json::Writer<json::StringBuffer>&, const config::uuid_override&);
void rjson_serialize(
  json::Writer<json::StringBuffer>&, const config::id_override&);

void rjson_serialize(
  json::Writer<json::StringBuffer>&, const std::vector<config::uuid_override>&);
void rjson_serialize(
  json::Writer<json::StringBuffer>&, const std::vector<config::id_override>&);
