...
constexpr static std::array feature_schema{
  ...
  feature_spec{
    ...
    feature_spec::prepare_policy::always},
  feature_spec{
    to_cluster_version(release_version::v22_2_6),
    "transaction_ga",
  ...
  feature_spec{
    ...
    feature_spec::prepare_policy::always},
  feature_spec{
    to_cluster_version(release_version::v22_3_6),
    "tm_stm_cache",
    feature::tm_stm_cache,
    feature_spec::available_policy::always,
    feature_spec::prepare_policy::always},
  feature_spec{
    to_cluster_version(release_version::v23_1_1),
    "kafka_gssapi",
  ...
  feature_spec{
    ...
    feature_spec::prepare_policy::always},
  feature_spec{
    to_cluster_version(release_version::v23_2_1),
  ...
  feature_spec{
    ...
    feature_spec::prepare_policy::always},
  feature_spec{
    to_cluster_version(release_version::v23_3_1),
  ...
  feature_spec{
    ...
    feature_spec::prepare_policy::always},
  feature_spec{
    to_cluster_version(release_version::v24_1_1),
  ...
  feature_spec{
    ...
    feature_spec::prepare_policy::always},
  feature_spec{
    to_cluster_version(release_version::v24_2_1),
